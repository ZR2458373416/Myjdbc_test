...
public class UserProductDaoImpl implements UserProductDao {
    ...
    //查找商品的价格和打折情况
    @Override
    public List<UserTwoTable> selectAllTwo(String sql) {
        List<UserTwoTable> list=new ArrayList<>();
        Connection conn=null;
        PreparedStatement ps=null;
        ResultSet rs=null;
        ...
        try{
            ...
            while(rs.next()){
                ...
                //通过构造赋值
                UserTwoTable UserTwoTable=new UserTwoTable(prold,sku,title,effetiveStartDate,effetiveEndtDate,proce,typecd);
                //讲查询结果放入集合
